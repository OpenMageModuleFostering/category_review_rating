...
class Precursor_Categoryreview_Block_Adminhtml_Categoryreview extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	public function __construct()
	{
		$this->_controller = 'adminhtml_categoryreview';
		$this->_blockGroup = 'categoryreview';
		$this->_headerText = Mage::helper('categoryreview')->__('Manage All Reviews');
